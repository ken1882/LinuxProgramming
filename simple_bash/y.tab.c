...
int yylex();
int yyerror(char* s);
extern std::vector<int> YY_FLAGS;
...
#endif
/* Tokens.  */
#define CMD_IDENTIFIER 258
#define SYM_PIPE 259
#define RED_STDIN 260
#define RED_STDOUT 261
#define APP_STDOUT 262
#define RUN_DAEMON 263
#define CONT_INPUT 264
...
{
  "$end", "error", "$undefined", "CMD_IDENTIFIER", "SYM_PIPE",
  "RED_STDIN", "RED_STDOUT", "APP_STDOUT", "RUN_DAEMON", "CONT_INPUT",
  "$accept", "Commmand", YY_NULLPTR
};
#endif
